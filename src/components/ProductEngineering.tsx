...
function ProductEngineering() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mb-16 max-w-175">
        <div className="mb-4 flex items-center gap-3">
          <div className="from-background-primary/20 to-background-tertiary/20 flex h-12 w-12 items-center justify-center rounded-full bg-linear-to-br">
            <div className="from-background-primary to-background-tertiary h-6 w-6 rounded-full bg-linear-to-br" />
          </div>
        </div>
